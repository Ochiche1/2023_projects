...
public final class SqlQueries {
    ...
    public static final String SELECT_QUERY_FOR_QUEUE = "select tran_id, accountnumber, isOcode, acctname, acctype, drcr, transactionreference, amount, trandate, narration from orbit_cliq_outward_trans where process_status = 'Queued'";
public static final String UPDATE_QUERY_FOR_QUEUE = "update orbit_cliq_outward_trans set process_status = 'Processed' where tran_id = ?";
}
