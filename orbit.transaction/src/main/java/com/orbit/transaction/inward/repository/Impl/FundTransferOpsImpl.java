...
//
//    @Override
//    public boolean saveIntoFundTransferDebit(FundTransferDirectCreditResponse response, NIPRequestType requestType) {
...
//
//    @Override
//    public boolean isFundTransferSaved(FundTransferDirectCreditResponse response) {
